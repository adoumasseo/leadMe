...
def downgrade():
    ...
    sa.Column('nom', sa.VARCHAR(length=10), autoincrement=False, nullable=False),
    ...
    sa.Column('prenom', sa.VARCHAR(length=45), autoincrement=False, nullable=True),
    sa.Column('nom', sa.VARCHAR(length=45), autoincrement=False, nullable=True),
    sa.Column('email', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('password', sa.VARCHAR(length=200), autoincrement=False, nullable=True),
    sa.Column('role', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('deleted_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('serie', sa.VARCHAR(length=128), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['serie'], ['series.id_serie'], name='users_serie_fkey'),
